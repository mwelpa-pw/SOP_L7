...
// laczenie przez connect na udp(SOCK_DGRAM) w af_unix
// zwraca socket ktory domyslnie wysyla na podany adres
// wtedy moge uzywac write, send
...
// tworzenie bindowanie socketu do nazwy
...
// struktura adresu do wysylania danych udp
